  ...
  Object.freeze({
    ...
    objects: [
      ...
      },
      {
        ...
        ports: [
          { id: 'in-a', direction: 'input', label: 'Intake A', itemKeys: ['body_system'] },
          { id: 'in-b', direction: 'input', label: 'Intake B', itemKeys: ['neural_weave'] },
          { id: 'in-c', direction: 'input', label: 'Intake C', itemKeys: ['skeletal_frame'] },
          { id: 'in-d', direction: 'input', label: 'Intake D', itemKeys: ['glandular_network'] },
          {
            id: 'out-products',
            direction: 'output',
    ...
    links: [
      ...
      },
      {
        ...
        target: { objectId: 'constructor-omni', portId: 'in-a' },
      },
      {
        id: 'shell-to-storage',
        source: { objectId: 'constructor-omni', portId: 'out-products' },
  ...
  Object.freeze({
    ...
    links: [
      ...
      },
      {
        ...
        target: { objectId: 'constructor-omni-2', portId: 'in-b' },
      },
      {
        id: 'frame-to-caretaker',
        source: { objectId: 'vat-frame', portId: 'out-frame' },
        target: { objectId: 'constructor-omni-2', portId: 'in-c' },
      },
      {
        id: 'caretaker-to-ward',
        source: { objectId: 'constructor-omni-2', portId: 'out-products' },
